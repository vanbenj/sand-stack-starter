...
This project is a starter for building a [GRANDstack](https://grandstack.io) (Sveltejs, Apollo, Neo4j, GraphQL) application. There are two components to the starter, the UI application (a Svelte/Sapper app) and the API app (GraphQL server).
